build/libkernel.a: kernel/Cargo.lock kernel/Cargo.toml kernel/src/* kernel/src/*/* kernel/src/*/*/* kernel/src/*/*/*/* build/initfs.tag
	...
	cd kernel && \
	xargo rustc --lib --target $(KTARGET) --release -- -C soft-float -C debuginfo=2 -C code-model=$(CODE_MODEL) --emit link=../$@
...
build/libkernel_live.a: kernel/Cargo.toml kernel/src/* kernel/src/*/* kernel/src/*/*/* kernel/src/*/*/*/* build/initfs_live.tag
	...
	cd kernel && \
	xargo rustc --lib --target $(KTARGET) --release --features live -- -C soft-float -C debuginfo=2 -C code-model=$(CODE_MODEL) --emit link=../$@
